...
void sha1_process(unsigned int hash[], unsigned char msg[]) {
  ...
  int i;
  // Fast endianness conversion using builtin
  const unsigned int *msg32 = (const unsigned int *)msg;
  for (i = 0; i < 16; i++) {
    W[i] = __builtin_bswap32(msg32[i]);
  }
  for (i = 16; i < 80; i++) {
...
void sha512_msg_pad(unsigned char message[], int size, unsigned int bitlen,
                    unsigned char paddedmsg[]) {
  int i;
  for (i = 0; i < size; i++) {
    paddedmsg[i] = message[i];
...
void sha512_process(unsigned long hash[], unsigned char msg[]) {
  const unsigned long K[80] = {
      ...
      0x5fcb6fab3ad6faec, 0x6c44198c4a475817};
  unsigned long W[80];
  unsigned long A, B, C, D, E, F, G, H, T1, T2, X, Y, X1, Y1, X2, Y2, X3, Y3,
      X4, Y4;

  // Fast endianness conversion using builtin for 64-bit
  const unsigned long *msg64 = (const unsigned long *)msg;
  for (int i = 0; i < 16; i++) {
    W[i] = __builtin_bswap64(msg64[i]);
  }
  ...
  X = D + T1;
  Y = T1 + T2;
  T1 = G + Sigma5121(X) + CH(X, E, F) + K[1] + W[1];
  T2 = Sigma5120(Y) + MAJ(Y, A, B);
  X1 = C + T1;
  Y1 = T1 + T2;
  T1 = F + Sigma5121(X1) + CH(X1, X, E) + K[2] + W[2];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, A);
  X2 = B + T1;
  Y2 = T1 + T2;
  T1 = E + Sigma5121(X2) + CH(X2, X1, X) + K[3] + W[3];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = A + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[4] + W[4];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[5] + W[5];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[6] + W[6];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[7] + W[7];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[8] + W[8];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[9] + W[9];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[10] + W[10];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[11] + W[11];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[12] + W[12];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[13] + W[13];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[14] + W[14];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[15] + W[15];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[16] + W[16];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[17] + W[17];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[18] + W[18];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[19] + W[19];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[20] + W[20];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[21] + W[21];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[22] + W[22];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[23] + W[23];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[24] + W[24];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[25] + W[25];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[26] + W[26];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[27] + W[27];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[28] + W[28];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[29] + W[29];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[30] + W[30];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[31] + W[31];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[32] + W[32];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[33] + W[33];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[34] + W[34];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[35] + W[35];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[36] + W[36];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[37] + W[37];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[38] + W[38];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[39] + W[39];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[40] + W[40];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[41] + W[41];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[42] + W[42];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[43] + W[43];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[44] + W[44];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[45] + W[45];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[46] + W[46];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[47] + W[47];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[48] + W[48];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[49] + W[49];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[50] + W[50];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[51] + W[51];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[52] + W[52];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[53] + W[53];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[54] + W[54];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[55] + W[55];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[56] + W[56];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[57] + W[57];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[58] + W[58];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[59] + W[59];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[60] + W[60];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[61] + W[61];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[62] + W[62];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[63] + W[63];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[64] + W[64];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[65] + W[65];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[66] + W[66];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[67] + W[67];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[68] + W[68];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[69] + W[69];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[70] + W[70];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[71] + W[71];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[72] + W[72];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[73] + W[73];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[74] + W[74];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
  T1 = X1 + Sigma5121(X4) + CH(X4, X3, X2) + K[75] + W[75];
  T2 = Sigma5120(Y4) + MAJ(Y4, Y3, Y2);
  X = Y1 + T1;
  Y = T1 + T2;
  T1 = X2 + Sigma5121(X) + CH(X, X4, X3) + K[76] + W[76];
  T2 = Sigma5120(Y) + MAJ(Y, Y4, Y3);
  X1 = Y2 + T1;
  Y1 = T1 + T2;
  T1 = X3 + Sigma5121(X1) + CH(X1, X, X4) + K[77] + W[77];
  T2 = Sigma5120(Y1) + MAJ(Y1, Y, Y4);
  X2 = Y3 + T1;
  Y2 = T1 + T2;
  T1 = X4 + Sigma5121(X2) + CH(X2, X1, X) + K[78] + W[78];
  T2 = Sigma5120(Y2) + MAJ(Y2, Y1, Y);
  X3 = Y4 + T1;
  Y3 = T1 + T2;
  T1 = X + Sigma5121(X3) + CH(X3, X2, X1) + K[79] + W[79];
  T2 = Sigma5120(Y3) + MAJ(Y3, Y2, Y1);
  X4 = Y + T1;
  Y4 = T1 + T2;
