...
int main (int argc, char *argv[]) {
  ...
  int t1RLCE = 2; /* 1: test function; 2: test performance */
  int tRLCE = 2; /* 1: test function; 2: test performance */
  ...
  int tpolyMatper =0; /* compare the performance of matrix mul and inverse */
